...
echo "  kubectl port-forward svc/documentdb-service-my-documentdb 10260:10260 -n documentdb-ns"
echo "  mongosh 'mongodb://dev_user:DevPassword123@127.0.0.1:10260/?directConnection=true&authMechanism=SCRAM-SHA-256&tls=true&tlsAllowInvalidCertificates=true'"
echo ""
