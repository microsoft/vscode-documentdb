...
/**
 * Generates index optimization suggestions for the selected query
 ...
 */
export async function generateIndexSuggestionCommand(
...
/**
 * Displays the optimization recommendations
...
${jsonRecommendations.verification}
