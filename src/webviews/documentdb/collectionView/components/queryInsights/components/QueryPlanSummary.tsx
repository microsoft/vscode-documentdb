...
import { Badge, Button, Card, Label, Tab, TabList, Text } from '@fluentui/react-components';
import { DismissRegular, InfoRegular, LayerRegular } from '@fluentui/react-icons';
...
export const QueryPlanSummary: React.FC<QueryPlanSummaryProps> = ({
    ...
    const containerClass = inPanel ? 'queryPlanInPanel' : 'queryPlanWrapper';
