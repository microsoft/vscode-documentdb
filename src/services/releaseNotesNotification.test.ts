    ...
    describe('checkVersionForNotification', () => {
        ...
        describe('prerelease version handling', () => {
            it('should NOT show notification for prerelease build even when minor is higher (0.8.0-bugbash from 0.7.0)', () => {
                const result = checkVersionForNotification('0.8.0-bugbash', '0.7.0', false);
            ...
            it('should NOT show notification for prerelease on first install', () => {
                const result = checkVersionForNotification('0.8.0-preview', undefined, false);
            ...
            it('should NOT update stored version fields for prerelease builds', () => {
                const result = checkVersionForNotification('0.9.0-beta', '0.8.0', false);
        ...
        describe('transitional code for 0.7.0 upgrade', () => {
            ...
            it('should show notification for pre-0.7.0 upgrade even with prerelease version', () => {
                ...
                // Prerelease builds skip everything — even transitional upgrade detection
                expect(result.shouldShowNotification).toBe(false);
                expect(result.isPrerelease).toBe(true);
                expect(result.isUpgradeFromPre070).toBe(false);
            });
        });
