...
export class StreamDocumentWriter {
    ...
    private formatProgressDetails(
        ...
        const skipped = optimisticCounts?.skipped ?? this.totalCollided;
    ...
    public async streamDocuments(
        ...
        if (options?.actionContext) {
            ...
            options.actionContext.telemetry.measurements.streamTotalCollided = this.totalCollided;
    ...
    private async flushBuffer(
        ...
        const result = await this.writer.writeDocuments(this.buffer, {
            ...
            progressCallback: (batchDetails) => {
                ...
                if (onProgress && processedCount > 0) {
                    ...
                    const cumulativeSkipped = this.totalCollided + flushSkipped;
        ...
        this.totalCollided += result.collidedCount ?? 0;
