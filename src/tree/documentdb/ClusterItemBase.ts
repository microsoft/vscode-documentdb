    ...
    implements TreeElement, TreeElementWithExperience, TreeElementWithContextValue, TreeElementWithRetryChildren
{
     ...
     *
     * @returns A connected client, or `null` when authentication failed or the user
     *          cancelled — callers should abort quietly in that case, because the
     *          authentication flow has already reported the reason.
     */
