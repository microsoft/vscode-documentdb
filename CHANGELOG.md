...
- **Query Insights Performance**: Updated the Query Insights feature to use GPT-4o model and refined prompt structure with enhanced security measures. This significantly improves response time and strengthens protection against prompt injection attacks. [#468](https://github.com/microsoft/vscode-documentdb/pull/468)
- **Connection String Trimming**: Connection string inputs are now trimmed and validated to prevent empty entries, ensuring valid connections when users paste with whitespace. [#467](https://github.com/microsoft/vscode-documentdb/pull/467)
- **Collection Count Updates**: Collection metadata, including document count estimates, now updates correctly after paste operations, even in partial failure scenarios. [#482](https://github.com/microsoft/vscode-documentdb/pull/482)
- **Output Log Visibility**: Enhanced error logging during paste operations to ensure all write errors, including unique index violations, are properly displayed in the output log. Task failures now automatically reveal the output channel. [#484](https://github.com/microsoft/vscode-documentdb/pull/484)

### Community Contributions

- **Alphabetical Collection Sorting**: Collections within MongoDB databases are now displayed in alphabetical order for better readability and consistency. Contributed by [@VanitasBlade](https://github.com/VanitasBlade), fixing issue [#456](https://github.com/microsoft/vscode-documentdb/issues/456) reported by [@majelbstoat](https://github.com/majelbstoat). [#465](https://github.com/microsoft/vscode-documentdb/pull/465)
...
- **Query Parsing Error Handling**: Fixed invalid JSON query inputs no longer being silently replaced with empty objects. Parse failures now surface clear error messages with helpful JSON examples, improving user feedback. Reported by [@majelbstoat](https://github.com/majelbstoat) in [#458](https://github.com/microsoft/vscode-documentdb/issues/458). [#471](https://github.com/microsoft/vscode-documentdb/pull/471)
- **Monaco Editor Keyboard Paste**: Restored keyboard paste functionality (Ctrl+V/Cmd+V) in Query Editor and Document View by downgrading Monaco Editor to 0.52.2. Resolves regression introduced in Monaco 0.53.x/0.54.x. Reported by [@cveld](https://github.com/cveld) in [#435](https://github.com/microsoft/vscode-documentdb/issues/435). [#470](https://github.com/microsoft/vscode-documentdb/pull/470)
- **Document Import from Discovery View**: Fixed failing document imports from the Azure Service Discovery View for Azure Cosmos DB for MongoDB (RU) resources. Connection strings are now properly retrieved even when metadata cache is not yet populated. [#368](https://github.com/microsoft/vscode-documentdb/issues/368), [#479](https://github.com/microsoft/vscode-documentdb/pull/479)
- **Azure Resources View Connectivity**: Resolved connection failures when expanding Azure DocumentDB clusters in the Azure Resources view. Resource group information is now correctly extracted from resource IDs, ensuring reliable connectivity. [#480](https://github.com/microsoft/vscode-documentdb/pull/480)
