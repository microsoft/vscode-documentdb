...
const OPERATOR_DOC_BASE =
    'https://raw.githubusercontent.com/MicrosoftDocs/nosql-docs/main/documentdb/query/operators';
...
async function buildGlobalFileIndex(): Promise<Map<string, string>> {
    const GITHUB_API_BASE =
        'https://api.github.com/repos/MicrosoftDocs/nosql-docs/contents/documentdb/query/operators';
