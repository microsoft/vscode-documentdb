...
const arithmeticExpressionOperators: readonly OperatorEntry[] = [
    ...
    },
    {
        ...
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/evaluation-query/$mod', // inferred from another category
    },
    {
        value: '$multiply',
        meta: META_EXPR_ARITH,
...
const arrayExpressionOperators: readonly OperatorEntry[] = [
    ...
    },
    {
        ...
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/accumulators/$firstn', // inferred from another category
    },
    {
        value: '$in',
        meta: META_EXPR_ARRAY,
        ...
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/comparison-query/$in', // inferred from another category
    },
    {
        value: '$indexOfArray',
        meta: META_EXPR_ARRAY,
    ...
    },
    {
        ...
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/accumulators/$lastn', // inferred from another category
    },
    {
        value: '$map',
        meta: META_EXPR_ARRAY,
    ...
    },
    {
        ...
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/object-expression/$objecttoarray', // inferred from another category
    },
    {
        value: '$range',
        meta: META_EXPR_ARRAY,
    ...
    },
    {
        ...
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/array-query/$size', // inferred from another category
    },
    {
        value: '$slice',
        meta: META_EXPR_ARRAY,
...
const booleanExpressionOperators: readonly OperatorEntry[] = [
    {
        ...
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/logical-query/$and', // inferred from another category
    },
    {
        value: '$not',
        meta: META_EXPR_BOOL,
        ...
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/logical-query/$not', // inferred from another category
    },
    {
        value: '$or',
        meta: META_EXPR_BOOL,
        ...
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/logical-query/$or', // inferred from another category
    },
];
...
const comparisonExpressionOperators: readonly OperatorEntry[] = [
    ...
    },
    {
        ...
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/comparison-query/$eq', // inferred from another category
    },
    {
        value: '$gt',
        meta: META_EXPR_COMPARISON,
        ...
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/comparison-query/$gt', // inferred from another category
    },
    {
        value: '$gte',
        meta: META_EXPR_COMPARISON,
        ...
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/comparison-query/$gte', // inferred from another category
    },
    {
        value: '$lt',
        meta: META_EXPR_COMPARISON,
        ...
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/comparison-query/$lt', // inferred from another category
    },
    {
        value: '$lte',
        meta: META_EXPR_COMPARISON,
        ...
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/comparison-query/$lte', // inferred from another category
    },
    {
        value: '$ne',
        meta: META_EXPR_COMPARISON,
        ...
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/comparison-query/$ne', // inferred from another category
    },
];
...
const dateExpressionOperators: readonly OperatorEntry[] = [
    ...
    },
    {
        ...
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/aggregation/$todate', // inferred from another category
    },
    {
        value: '$week',
        meta: META_EXPR_DATE,
...
const miscellaneousOperators: readonly OperatorEntry[] = [
    ...
    },
    {
        ...
        snippet: '{ $rand: {} }',
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/miscellaneous-query/$rand', // inferred from another category
    },
    {
        value: '$sampleRate',
        meta: META_EXPR_MISC,
...
const stringExpressionOperators: readonly OperatorEntry[] = [
    ...
    },
    {
        ...
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/date-expression/$datefromstring', // inferred from another category
    },
    {
        value: '$dateToString',
        meta: META_EXPR_STRING,
        ...
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/date-expression/$datetostring', // inferred from another category
    },
    {
        value: '$indexOfBytes',
        meta: META_EXPR_STRING,
    ...
    },
    {
        ...
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/aggregation/$tostring', // inferred from another category
    },
    {
        value: '$trim',
        meta: META_EXPR_STRING,
...
const typeExpressionOperators: readonly OperatorEntry[] = [
    ...
    },
    {
        ...
        link: 'https://learn.microsoft.com/en-us/documentdb/query/operators/element-query/$type', // inferred from another category
    },
];
