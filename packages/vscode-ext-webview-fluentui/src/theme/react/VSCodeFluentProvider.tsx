 ...
 *
 * Built only from the package's own public `useActiveVSCodeTheme` hook. A consumer who has to own
 * their `FluentProvider` can call that hook and pass its `theme` to get identical reactive
 * behavior.
 */
