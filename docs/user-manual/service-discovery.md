...
All service discovery plugins are visible by default. If a provider is not relevant to your workflow, you can hide it from the Service Discovery tree and bring it back later with **Explore Providers...**.
