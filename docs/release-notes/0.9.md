...
- **Paste kubeconfig YAML…**: paste YAML directly; it is kept in VS Code Secret Storage.
...
<!-- IMAGE PLACEHOLDER: 0.9.0_kubernetes_add_source.png
     ...
     "Default kubeconfig", "Kubeconfig file…", and "Paste kubeconfig YAML…".
     Capture it while the quick pick is focused so the options list is visible.
     Width: 600 px. -->
<p align="center"><img src="./images/0.9.0_kubernetes_add_source.png" alt="Add Kubeconfig quick pick showing the three source options: Default kubeconfig, Kubeconfig file, and Paste kubeconfig YAML" width="600" style="max-width:100%;height:auto;"></p>
