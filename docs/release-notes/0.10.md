...
For the complete guide, see [Manage Indexes in Collection View](https://microsoft.github.io/vscode-documentdb/user-manual/collection-view-index-management), [Wildcard Indexes in Collection View](https://microsoft.github.io/vscode-documentdb/user-manual/collection-view-wildcard-indexes), and [Troubleshoot Index Management](https://microsoft.github.io/vscode-documentdb/user-manual/collection-view-index-management-troubleshooting).
