...
Resolved UI rendering issues that affected users of dark themes like Nord. Text in certain controls was dark-on-dark and invisible, making parts of the interface unusable. All UI elements now properly respect theme colors for better visibility in both light and dark modes. **Reported by [@majelbstoat](https://github.com/majelbstoat)** in [#435](https://github.com/microsoft/vscode-documentdb/issues/457).
