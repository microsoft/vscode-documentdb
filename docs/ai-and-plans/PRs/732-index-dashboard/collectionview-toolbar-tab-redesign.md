...
| [ToolbarMainView.tsx](../../../../src/webviews/documentdb/collectionView/components/toolbar/ToolbarMainView.tsx)                                                                                               | Renamed to `CollectionQueryActionBar.tsx`; becomes the reusable Documents / Query Insights query action bar. |
...
| 2. Make the query action bar contextual     | In progress | Pending.                                                                                                                              |
| 3. Give Indexes direct action ownership     | Not started | Pending.                                                                                                                              |
| 4. Normalize layout and responsive behavior | Not started | Pending.                                                                                                                              |
| 5. Accessibility and content pass           | Not started | Pending.                                                                                                                              |
| 6. Localization and focused tests           | Not started | Pending.                                                                                                                              |
