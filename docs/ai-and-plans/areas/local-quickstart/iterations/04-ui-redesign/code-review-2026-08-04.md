...
| **N7** | The `docs/ai-and-plans/areas/local-quickstart/iterations/02-poc/` and `653-local-quickstart-design/` folders both carry plan docs for this feature, now joined by `docs/ai-and-plans/areas/local-quickstart/`.                                                                                           | Consolidate under one PR folder before merge so the next reader has one entry point.                                           |
