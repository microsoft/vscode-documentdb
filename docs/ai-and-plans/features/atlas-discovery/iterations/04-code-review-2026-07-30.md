...
`feature/atlas-discovery`). This document lives under `docs/ai-and-plans/features/atlas-discovery/iterations/`
...
The design history in `docs/ai-and-plans/features/atlas-discovery/` was consulted to avoid
