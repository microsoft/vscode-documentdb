...
**Plan:** [`managed-identities.md`](../design.md)
...
and `recentManagedIdentities.ts` (since removed), with tests.
...
[755-no-auth-support/review-2026-06-23.md](../../no-auth/iterations/01-no-auth-support/review-2026-06-23.md),
...
- **Errors are not always `instanceof Error`.** Under Jest the thrown value did not satisfy
  ...
  [§9](../design.md) does for the Playground and Shell.
...
- New [docs/user-manual/connect-with-managed-identity.md](../../../../user-manual/connect-with-managed-identity.md),
...
- A **Managed identity connections** section in
  [copy-connection-string.md](../../../../user-manual/copy-connection-string.md), including why no password
...
**Documentation.** [connect-with-managed-identity.md](../../../../user-manual/connect-with-managed-identity.md)
