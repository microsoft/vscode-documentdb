...
- **Related design docs:** [decisions](../decisions.md),
  [implementation log](01-implementation-log.md),
  [manual validation checklist](../manual-validation-checklist.md), and
  [code-review ledger](02-code-review.md)
